...
export default {
  ...
  methods: {
    ...mapActions('videos', {
      videoCommentReplies: VIDEO_COMMENT_REPLIES,
      videoCommentReplyCreate: VIDEO_COMMENT_REPLY_CREATE,
      videoCommentReplyUpdate: VIDEO_COMMENT_REPLY_UPDATE,
    }),
    handleMessageSend() {
      this.videoCommentReplyCreate({
        videoCommentId: this.replyDetail.commentId,
    ...
    handleReplyUpdate () {
      ...
      this.videoCommentReplyUpdate({
        videoCommentReplyId: this.updateReply.commentReplyId,
  ...
  watch: {
    action() {
      this.drawer = true
      this.title = this.replyDetail.videoName
      this.videoCommentReplies({
        videoCommentId: this.replyDetail.commentId
      }).then(res => {
