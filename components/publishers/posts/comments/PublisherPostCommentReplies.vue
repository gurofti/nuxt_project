...
export default {
  ...
  methods: {
    ...mapActions('publishers', {
      publisherPostCommentReplies: PUBLISHER_POST_COMMENT_REPLIES,
      publisherPostCommentReplyCreate: PUBLISHER_POST_COMMENT_REPLY_CREATE,
      publisherPostCommentReplyUpdate: PUBLISHER_POST_COMMENT_REPLY_UPDATE,
    }),
    handleMessageSend() {
      this.publisherPostCommentReplyCreate({
        publisherPostCommentId: this.replyDetail.commentId,
    ...
    handleReplyUpdate () {
      ...
      this.publisherPostCommentReplyUpdate({
        publisherPostCommentReplyId: this.updateReply.commentReplyId,
  ...
  watch: {
    action() {
      this.drawer = true
      this.title = this.replyDetail.publisherPostName
      this.publisherPostCommentReplies({
        publisherPostCommentId: this.replyDetail.commentId
      }).then(res => {
